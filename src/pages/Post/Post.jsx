...
function Post() {
  ...
  return (
    <div className={styles.wrappermain}>
        ...
        {
            login!="true" && <div className={styles.wrapper}>
            <div className={styles.ask}>
        <Link to={`/?login=false`}><button className={'btn btn-primary '+styles.askbtn}>Ask A Question</button></Link>
      </div>
    </div>
        }
